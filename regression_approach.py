...
class MovieLensTrainDataset(Dataset):
    ...
    def get_dataset(self, ratings, all_movieIds):
        ...
        for (u, i) in (user_item_set):
            ...
            for _ in range(num_negatives):  # TODO: eliminate this and try with all movies
...
if __name__ == "__main__":
    ...
    #train the model
    # trainer = pl.Trainer(max_epochs=20, reload_dataloaders_every_epoch=True, progress_bar_refresh_rate=50, logger=False,
